...
/**
 * 레이블(JLabel) 컴포넌트 클래스
 * - (참고) https://www.javatopint.com/java-jlabel
 * - 한 줄의 읽기 전용 텍스트를 표시하는 데 사용됩니다.
 * - JLabel 클래스의 개체는 프레임(컨테이너)에 텍스트를 배치하기 위한 구성 요소입니다.
 * - 텍스트는 응용 프로그램에서 변결할 수 있지만 사용자가 직접 편집할 수는 없다.
